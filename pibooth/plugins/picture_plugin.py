...
class PicturePlugin(object):
    ...
    def __init__(self, plugin_manager):
        ...
        self.third_previous_picture = None
        self.texts_vars = {}
    ...
    def _reset_vars(self, app):
        ...
        # app.previous_previous_picture = None
        app.previous_animated = None
        app.previous_picture_file = None
        # app.previous_previous_picture_file = None
    ...
    def state_processing_enter(self, app):
        self.third_previous_picture = app.previous_previous_picture
        app.previous_previous_picture = app.previous_picture
        app.previous_previous_picture_file = app.previous_picture_file
        self._reset_vars(app)
    ...
    #         self._reset_vars(app)
    #         app.previous_picture = app.previous_previous_picture
    #         app.previous_previous_picture = self.third_previous_picture
